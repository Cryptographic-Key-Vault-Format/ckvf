...
- **MUST NOT** silently redefine CKVF behavior to match Go conventions or a vendor product.
...
Functions currently `panic`. Do not treat a future green CI badge as conformance until real tests pin a test-vector `VERSION`.
